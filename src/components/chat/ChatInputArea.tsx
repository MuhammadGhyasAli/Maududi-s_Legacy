...
const ChatInputArea: React.FC<ChatInputAreaProps> = ({
  ...
  return (
    <>
      <div className="flex-none px-4 pb-4 pt-4 bg-gradient-to-t from-brand-bg-light via-brand-bg-light to-transparent dark:from-brand-bg-dark dark:via-brand-bg-dark dark:to-transparent">
                  ...
                  <div className="absolute bottom-full left-0 mb-1.5 w-28 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden z-20">
                    {languages.map(lang => (
                      <button
                        ...
                        className={`cursor-pointer w-full text-left px-3 py-1.5 text-xs transition-colors ${selectedLanguage === lang ? 'bg-brand-green text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'}`}
                      >
                        {lang}
                      </button>
                    ))}

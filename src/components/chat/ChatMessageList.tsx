...
function SpeakerButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleClick}
      className={`${isPlaying ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'} cursor-pointer p-1.5 rounded-lg text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 transition-all shrink-0`}

  ...
  if (error) {
    return (
      <div className="text-center">
        ...
        <Link href="/auth/login" className="inline-flex px-5 py-2 rounded-lg bg-brand-green hover:bg-brand-green-dark text-white font-medium text-sm transition-all">
          Back to Sign In
        </Link>
      </div>
    );

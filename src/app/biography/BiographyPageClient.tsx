  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center flex-shrink-0 pt-1.5">
        <div className="w-3 h-3 rounded-full bg-emerald-500 ring-4 ring-gray-50 dark:ring-gray-950 shadow-sm z-10" />
...
export default function BiographyPageClient() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section
        ref={heroRef}
        className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-emerald-50/60 to-gray-50 dark:from-gray-950 dark:via-emerald-950/40 dark:to-gray-950 pt-20 pb-16 sm:pt-28 sm:pb-24"
      >
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_0%,rgba(5,150,105,0.15),transparent_60%)] dark:bg-[radial-gradient(ellipse_at_50%_0%,rgba(5,150,105,0.12),transparent_60%)] pointer-events-none" />
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            >
              <motion.div
                ...
                className="relative w-52 h-64 sm:w-60 sm:h-[19rem] md:w-64 md:h-80 rounded-2xl overflow-hidden shadow-2xl ring-2 ring-gray-200 dark:ring-white/10"
              >
                <Image
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-600/10 border border-emerald-600/20 dark:bg-emerald-500/10 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400 text-sm font-medium mb-5">
                <Landmark className="w-3.5 h-3.5" aria-hidden="true" />
                Scholar &bull; Philosopher &bull; Jurist &bull; Journalist
              </span>

              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-5 leading-[1.1] tracking-tight">
                Sayyid Abul A&apos;la{' '}
              ...
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-xl mx-auto md:mx-0 leading-relaxed">
                Founder of Jamaat-e-Islami, author of{' '}
                <em className="text-gray-800 dark:text-gray-300 not-italic font-medium">Tafhim-ul-Quran</em>,
              ...
              <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/80 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white font-medium hover:bg-gray-100 dark:hover:bg-white/10 transition-all duration-300 text-sm"
                >
      ...
      <section className="py-16 sm:py-20 max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <div className="space-y-4 text-base text-gray-700 dark:text-gray-400">
            <p className="leading-relaxed">
              Biographical information is drawn from{' '}
              <a href="https://en.wikipedia.org/wiki/Abul_A%27la_Maududi" target="_blank" rel="noopener noreferrer" className="underline decoration-emerald-500/40 hover:decoration-emerald-600 hover:text-emerald-700 dark:decoration-emerald-500/30 dark:hover:decoration-emerald-500 dark:hover:text-emerald-400 transition-colors">Wikipedia (CC BY-SA 4.0)</a>,{' '}
              <a href="https://www.encyclopedia.com/people/history/south-asian-biographies/abul-ala-maududi" target="_blank" rel="noopener noreferrer" className="underline decoration-emerald-500/40 hover:decoration-emerald-600 hover:text-emerald-700 dark:decoration-emerald-500/30 dark:hover:decoration-emerald-500 dark:hover:text-emerald-400 transition-colors">Encyclopedia.com</a>,{' '}
              <a href="https://global.oup.com/academic/product/encyclopedia-of-islam-and-the-muslim-world-9780199754564" target="_blank" rel="noopener noreferrer" className="underline decoration-emerald-500/40 hover:decoration-emerald-600 hover:text-emerald-700 dark:decoration-emerald-500/30 dark:hover:decoration-emerald-500 dark:hover:text-emerald-400 transition-colors">Oxford Encyclopedia of Islam and the Muslim World</a>,
              and official{' '}
              <a href="https://jamaat.org" target="_blank" rel="noopener noreferrer" className="underline decoration-emerald-500/40 hover:decoration-emerald-600 hover:text-emerald-700 dark:decoration-emerald-500/30 dark:hover:decoration-emerald-500 dark:hover:text-emerald-400 transition-colors">Jamaat-e-Islami</a>{' '}
